...
"""
This code is a modified version of "MeshToTruss.py" from the 3D-printed splints demo tutorial.

Original Copyright (c) 2021 maxSIMhealth

Permission is granted for non-commercial use under the terms of the original license.

Original source: https://github.com/sim3DMedLab/3D-printed-splints-demo-tutorial/blob/main/3%20Create%203D%20splint%20model/MeshToTruss.py

Modifications made by Sepehr Sohrabi in 2025.
"""
